...
export const options = {
  scenarios: {
    default: {
      ...
      vus: 1,
      duration: '200m', // Increase the total test duration
    },
  },
  thresholds: {
    checks: ['rate==1.0'],
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0YW52aXIua2hhbkBiaml0Z3JvdXAuY29tIiwiZXhwIjoxNzI1MDAwMjUxLCJpYXQiOjE3MjQ5MTM4NTF9.-WpFJS3UpO3TZe_-fTaX1nLOYnHuuw_L4ej4lIKMWjE'
      },
      timeout: '6000000000ms'
    };

    const formData = {
      csv_file: http.file(payload, 'SP16 importing 15K devices US_VUs 1 using k6 testing tool', 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/SP16_html_report_15K_devices_US_VUs 1_${currentTime}.html`]: htmlReport(data),
  };
}
