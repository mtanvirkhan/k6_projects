...
export default function () {
  group("Testing PT Console API", function () {
    ...
    group("Import data checking", function () {
      ...
      let res2 = http.get(`https://qa-global-consolebk.pocketalk.com/iotconsoleapi-global-bo/api/private/devicelist?searchText=US%20Shadman%20Corp&currentPageNumber=0&rowLimitPerPage=100&colName=&sortDirection=&serverRegionIdList=`, params);
