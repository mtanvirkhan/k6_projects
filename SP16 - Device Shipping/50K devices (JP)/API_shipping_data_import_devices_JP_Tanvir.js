...
export const options = {
  scenarios: {
    default: {
      ...
      vus: 1,
      duration: '40m', // Increase the total test duration
    },
  },
  thresholds: {
    checks: ['rate==1.0'],
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0YW52aXIua2hhbkBiaml0Z3JvdXAuY29tIiwiZXhwIjoxNzI0OTA4MjA0LCJpYXQiOjE3MjQ4MjE4MDR9.pDXP9-OUeD6q63DKtlDqHk-QgLfB4DF-SBqQcpyAgCM'
      },
      timeout: '600000000ms'
    };

    const formData = {
      csv_file: http.file(payload, 'SP16 importing 5K devices JP_VUs 1 using k6 testing tool', 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/SP16_html_report_5K_devices_JP_VUs 1_${currentTime}.html`]: htmlReport(data),
  };
}
