...
// Initialize logData variable
let logData = '';

// Load CSV data
const csvData = new SharedArray('another data name', function () {
  return open('./SP15_47.5K_devices_BJIT_Rifat.csv')
    .split('\n')
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJyLnNoYWRtYW5AYmppdGdyb3VwLmNvbSIsImV4cCI6MTcyMzcxMTA5NywiaWF0IjoxNzIzNjI0Njk3fQ.f7y_Fbqj3zjNkyLc7ojBnSj7FgdQ_Az5VuobKhVhxCU'
      },
      timeout: '6000000ms'
    };

    const formData = {
      csv_file: http.file(payload, 'Up-loading 47.5K devices US_VUs 1 using k6 testing tool', 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/html_report_47.5K_devices_US_VUs 1_${currentTime}.html`]: htmlReport(data),
  };
}
