...
const csvData = new SharedArray('another data name', function () {
  return open('./SP15_50K_devices_BJIT_Rifat.csv')
    .split('\n')
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0YW52aXIua2hhbkBiaml0Z3JvdXAuY29tIiwiZXhwIjoxNzIzNzgzNzMxLCJpYXQiOjE3MjM2OTczMzF9.2YiqONGA0z2K1H1kQaTSVxAFsjRvQLZhC0gCo2u0kLw'
      },
      timeout: '6000000ms'
    };

    const formData = {
      csv_file: http.file(payload, 'Up-loading 50K devices JP_VUs 1 using k6 testing tool', 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/html_report_50K_devices_JP_VUs 1_${currentTime}.html`]: htmlReport(data),
  };
}
