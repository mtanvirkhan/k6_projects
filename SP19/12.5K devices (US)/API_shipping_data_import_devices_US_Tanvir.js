...
const csvData = new SharedArray('another data name', function () {
  return open('./SP19_T4 CW Tanvir v8.csv')
    .split('\n')
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0YW52aXIua2hhbkBiaml0Z3JvdXAuY29tIiwiZXhwIjoxNzI4MTEyNDk0LCJpYXQiOjE3MjgwMjYwOTR9.H3yZBnCfUDz2Esf4FOtG0CrtaktMYuefSEvsYxquAGQ'
      },
      timeout: '6000000000ms'
    };

    const formData = {
      csv_file: http.file(payload, `SP19 importing 12.5K devices US_VUs 1 using k6 testing tool ${currentTime} Tanvir`, 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/SP19_html_report_12.5K_devices_US_VUs 1_${currentTime} Tanvir.html`]: htmlReport(data),
  };
}
