...
export default function () {
  group("Testing PT Console API", function () {
    ...
    const params = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0YW52aXIua2hhbkBiaml0Z3JvdXAuY29tIiwiZXhwIjoxNzI3OTI4MDMwLCJpYXQiOjE3Mjc4NDE2MzB9.uTeQqUn1ee72jExbLaVHtiYOnnEfrJUujEa8L_5f4r8'
      },
      timeout: '1000000ms'
    };
