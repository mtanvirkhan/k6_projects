...
const csvData = new SharedArray('another data name', function () {
  return open('./SP19_T4 CW Tanvir v3.csv')
    .split('\n')
...
export const options = {
  scenarios: {
    default: {
      ...
      vus: 1,
      duration: '60m', // Increase the total test duration
    },
  },
  thresholds: {
    checks: ['rate==1.0'],
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJlbmFtdWwuaGFzYW5AYmppdGdyb3VwLmNvbSIsImV4cCI6MTcyNzk0MjY4NCwiaWF0IjoxNzI3ODU2Mjg0fQ.TxFw6W2-nZ-0s5dkF1DSrdYK2tO34Yc2MO7q6u6UWqg'
      },
      timeout: '6000000000ms'
    };

    const formData = {
      csv_file: http.file(payload, `SP19 importing 12.5K devices US_VUs 4 using k6 testing tool ${currentTime} Enamul`, 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/SP19_html_report_12.5K_devices_US_VUs 4_${currentTime} Enamul.html`]: htmlReport(data),
  };
}
