...
const csvData = new SharedArray('another data name', function () {
  return open('./SP19_T4 CW Tanvir v2.csv')
    .split('\n')
...
export const options = {
  scenarios: {
    default: {
      ...
      vus: 1,
      duration: '80m', // Increase the total test duration
    },
  },
  thresholds: {
    checks: ['rate==1.0'],
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJsaXRvbi5taWFoQGJqaXRncm91cC5jb20iLCJleHAiOjE3Mjc5NDM5NDgsImlhdCI6MTcyNzg1NzU0OH0.PkgJrn5obBnttxOfWtC3E6xXtvCZC7H3Gi35iHo7k_c'
      },
      timeout: '6000000000ms'
    };

    const formData = {
      csv_file: http.file(payload, `SP19 importing 12.5K devices US_VUs 4 using k6 testing tool ${currentTime} Liton`, 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/SP19_html_report_12.5K_devices_US_VUs 4_${currentTime} Liton.html`]: htmlReport(data),
  };
}
