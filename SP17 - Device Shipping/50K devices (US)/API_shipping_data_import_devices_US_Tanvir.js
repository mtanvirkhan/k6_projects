...
const csvData = new SharedArray('another data name', function () {
  return open('./32.5K_US_Tanvir.csv')
    .split('\n')
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0YW52aXIua2hhbkBiaml0Z3JvdXAuY29tIiwiZXhwIjoxNzI2MTA5MDgyLCJpYXQiOjE3MjYwMjI2ODJ9.oxdmL9bUhZlVobtXJzY1kjbbG20mMpm98uarLbWBiCk'
      },
      timeout: '6000000000ms'
    };

    const formData = {
      csv_file: http.file(payload, 'SP17 importing 32.5K devices US_VUs 1 using k6 testing tool', 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/SP17_html_report_32.5K_devices_US_VUs 1_${currentTime}.html`]: htmlReport(data),
  };
}
