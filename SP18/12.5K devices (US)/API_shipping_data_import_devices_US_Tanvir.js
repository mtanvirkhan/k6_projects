...
const csvData = new SharedArray('another data name', function () {
  return open('./12.5K_US_Tanvir v4.csv')
    .split('\n')
...
export default function () {
  group('Testing PT Console API', function () {
    ...
    const JWT_token = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0YW52aXIua2hhbkBiaml0Z3JvdXAuY29tIiwiZXhwIjoxNzI2ODQ0NTAxLCJpYXQiOjE3MjY3NTgxMDF9.LSIxBw-m0WAUzjvbJ6NNepNpp6CrtpzDNtudb1mEo4w'
      },
      timeout: '6000000000ms'
    };

    const formData = {
      csv_file: http.file(payload, `SP18 importing 12.5K devices US_VUs 1 using k6 testing tool ${currentTime}`, 'text/csv'),
    };
...
export function handleSummary(data) {
  ...
  return {
    [`${outputDirectory}/SP18_html_report_12.5K_devices_US_VUs 1_${currentTime}.html`]: htmlReport(data),
  };
}
