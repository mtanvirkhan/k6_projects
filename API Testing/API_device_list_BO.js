...
export default function () {
  group("Testing PT Console API", function () {
    ...
    const params = {
      headers: {
        Authorization:
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0YW52aXIua2hhbkBiaml0Z3JvdXAuY29tIiwiZXhwIjoxNzI1MDg3NzczLCJpYXQiOjE3MjUwMDEzNzN9.TZcl1UihHe2a5YsUPASDRP884L61BTRGjAOmdVhzVGs'
      },
      timeout: '1000000ms'
    };
    ...
    group("Import data checking", function () {
      ...
      //let res1 = http.get(`https://qa-global-consolebk.pocketalk.com/iotconsoleapi-global-bo/api/private/devicelist?searchText=&currentPageNumber=0&rowLimitPerPage=100&colName=&sortDirection=&serverRegionIdList=`, params);
      let res2 = http.get(`https://qa-global-consolebk.pocketalk.com/iotconsoleapi-global-bo/api/private/devicelist?searchText=warehouse11100000004&currentPageNumber=0&rowLimitPerPage=100&colName=&sortDirection=&serverRegionIdList=`, params);

      console.log(`Response status: ${res2.status}`);
      console.log(`Response body: ${res2.body}`);
      //console.log(`Response body: ${res1.body}`);
      console.log(`Total devices: ${JSON.parse(res2.body).total_devices}`);
      console.log(`Total devices for US Shadman Corp: ${JSON.parse(res2.body).total_devices}`);
      console.log(`Response time: ${res2.timings.waiting} ms`);
      console.log(`Load time: ${res2.timings.duration} ms`);
