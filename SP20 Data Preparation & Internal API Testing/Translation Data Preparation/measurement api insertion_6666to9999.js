...
async function makeFetchCalls() {
  for (let i = 1; i < 300000; i++) {
    const raw = JSON.stringify({
      ...
      "fromlength": 63,
      "tolength": 21,
      "fromtext": `Rifat_SQA Load Testing. Count: ${i}`,
      "totext": `রিফাত_এসকিউএ লোড টেস্টিং. গণনা: ${i}`,
      "total": 1291,
      "timestamp": getCurrentTimestamp(),
      "imei1": "788877001950901",
      "imei2": "788877002950901",
    ...
    await new Promise(resolve => setTimeout(resolve, 500)); // Wait for 1 seconds
  }
}
