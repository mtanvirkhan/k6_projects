...
export default function () {
  const url = 'https://cw-consolebo.global.qa.pocketalk.com/iotconsoleapi-global-bo/api/private/devicelist';

  // Manually construct query string
  const queryString = '?searchText=&currentPageNumber=1&rowLimitPerPage=1&colName=&sortDirection=&serverRegionIdList=';
