...
export default function () {
  const url = 'https://cw-consolebo.global.qa.pocketalk.com/iotconsoleapi-global-bo/api/private/notification-list?searchText=&currentPageNumber=1&rowLimitPerPage=1&colName=&sortDirection=&serverRegionIdList=';
  ...
  const result = check(res, {
    ...
    'message is correct': (r) => jsonResponse.message === 'Success.', // Adjust based on actual message
  });
