...
export default function () {
  const url_ALL = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-from-lang-translation-info?from=19700101&to=20241202';
  const url_Previous_Week = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-from-lang-translation-info?from=20241125&to=20241201&type=NOTYEAR';
  const url_This_Week = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-from-lang-translation-info?from=20241202&to=20241208&type=NOTYEAR';
  const url_Previous_Month = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-from-lang-translation-info?from=20241101&to=20241130&type=NOTYEAR';
  const url_This_Month = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-from-lang-translation-info?from=20241201&to=20241231&type=NOTYEAR';
  const url_Previous_Year = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-from-lang-translation-info?from=20230101&to=20231231&type=YEAR';
  const url_This_Year = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-from-lang-translation-info?from=20240101&to=20241231&type=YEAR';
  ...
  check(res_ALL, {
    ...
    //'url_ALL: response body contains expected data': (r) => r.body.includes("expected key or value"), // Adjust as needed
  });
  console.log(`url_ALL Response status: ${res_ALL.status}`);
  //console.log(`url_ALL Response time: ${res_ALL.timings.waiting} ms`);
  console.log(`url_ALL Load time: ${res_ALL.timings.duration} ms`);
  //console.log(`url_ALL Body: ${res_ALL.body}`);
  ...
  //console.log(`url_Previous_Week Response time: ${res_Previous_Week.timings.waiting} ms`);
  console.log(`url_Previous_Week Load time: ${res_Previous_Week.timings.duration} ms`);
  //console.log(`url_Previous_Week Body: ${res_Previous_Week.body}`);
    ...
    //console.log(`url_This_Week Response time: ${res_This_Week.timings.waiting} ms`);
    console.log(`url_This_Week Load time: ${res_This_Week.timings.duration} ms`);
    //console.log(`url_This_Week Body: ${res_This_Week.body}`);
    ...
    check(res_Previous_Month, {
      ...
      //'url_Previous_Month: response body contains expected data': (r) => r.body.includes("expected key or value"), // Adjust as needed
    });
    console.log(`url_Previous_Month Response status: ${res_Previous_Month.status}`);
    //console.log(`url_Previous_Month Response time: ${res_Previous_Month.timings.waiting} ms`);
    console.log(`url_Previous_Month Load time: ${res_Previous_Month.timings.duration} ms`);
    //console.log(`url_Previous_Month Body: ${res_Previous_Month.body}`);
