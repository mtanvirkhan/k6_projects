...
export default function () {
  const url_ALL = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-total-translation-info?from=19700101&to=20241202';
  const url_Previous_Week = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-total-translation-info?from=20241125&to=20241201&type=NOTYEAR';
  const url_This_Week = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-total-translation-info?from=20241202&to=20241208&type=NOTYEAR';
  const url_Previous_Month = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-total-translation-info?from=20241101&to=20241130&type=NOTYEAR';
  const url_This_Month = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-total-translation-info?from=20241201&to=20241231&type=NOTYEAR';
  const url_Previous_Year = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-total-translation-info?from=20230101&to=20231231&type=YEAR';
  const url_This_Year = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/dashboard-total-translation-info?from=20240101&to=20241231&type=YEAR';
