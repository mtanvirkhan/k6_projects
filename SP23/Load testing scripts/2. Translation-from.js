...
export default function () {
  const url_Day = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/from-lang-list?corpId=ABCD1234567890123453&from=202412&to=202412&view=d';
  const url_Week = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/from-lang-list?corpId=ABCD1234567890123453&from=202412&to=202412&view=w';
  const url_Month = 'https://cw-console.us.qa.pocketalk.com/iotconsoleapi-co/api/private/from-lang-list?corpId=ABCD1234567890123453&from=202412&to=202412&view=m';
